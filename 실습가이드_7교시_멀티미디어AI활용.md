...
|-|-|-|
|`imageUrl`|String|`https://raw.githubusercontent.com/imguru-mooc/n8n\_agent/main/sample.png`|
...
2. Edit Fields 우측 **\[+]** → **Google Sheets** (Append Row):
   ...
   * 새 스프레드시트 **"자료분석\_로그"** (헤더: 파일명, 분석결과, 분석일시, 사용모델)
...
2. Edit Fields 우측 **\[+]** → **Google Sheets** (Append Row):
   ...
   * 스프레드시트 **"수업녹취\_로그"** (헤더: 녹취록, 학습노트, 생성일시)
